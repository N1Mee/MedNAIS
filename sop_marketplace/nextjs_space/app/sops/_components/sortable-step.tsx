        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <input
              ...
              min="0"
              className="w-40 px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#E63946] focus:border-transparent bg-white dark:bg-gray-800 text-sm"
            />
          </div>
