...
async def create_checkout_session(request_data: CreateCheckoutRequest, req: Request):
    """
    ...
    try:
        ...
        try:
            ...
            # For now, we'll extract user from Authorization header
            # In a real app, this should be extracted from JWT middleware
            ...
            await prisma.paymenttransaction.create(
                data={
                    ...
                    "userEmail": None  # Will be updated from user context
                }
            )
                ...
                if new_status == "COMPLETED" and checkout_status.payment_status == "paid":
                    ...
                    if sop_id and creator_id:
                        ...
                        if not existing_purchase:
                            ...
                            logger.info(f"Purchase record created for SOP {sop_id}")
...
async def create_cart_checkout_session(request_data: CreateCartCheckoutRequest, req: Request):
    """
